...
%% {\bf \small Research Assistant} \hfill {\small 2019 -- ongoing}\\
%% {\small Department of Politics and International Relations}\\
%% {\small University of Oxford, {\scshape gbr}}
...
\begin{benumerate}{3}
\item{\small Gonz\'alez-Bustamante, B. (2019). Participation, Political Information Consumption and Digital Social Media Usage in Argentina, Chile, and Uruguay. {\footnotesize \scshape [in Spanish, 2nd r\&r, {\bfseries \small Q4} 2018]}.}\vspace{1mm}

\item{\small Garrido-Vergara, L., \& Gonz\'alez-Bustamante, B. (2019). Public Opinion and Stateness: Evidence from the Chilean Case. {\footnotesize \scshape [in Spanish, 1st r\&r, {\bfseries \small Q4} 2018]}.}\vspace{1mm}

\item{\small Barr\'ia, D., \& Gonz\'alez-Bustamante, B. (2018). Explaining Transparency in Chilean Local Governments. {\footnotesize \scshape [1st r\&r , {\bfseries \small Q2} 2018]}.}
\end{benumerate}
...
\begin{itemize}
\item[$\circ$]{\small {\itshape Cuadernos FHyCS-UNJu}; {\itshape DAAPGE}; {\itshape Desaf\'ios}; {\itshape Estado, Gobierno y Gesti\'on P\'ublica}; {\itshape e-Ciencias de la Informaci\'on}; {\itshape Perspectivas de la Comunicaci\'on}; {\itshape Polis, Revista Latinoamericana}; {\itshape Pol\'itica, Revista de Ciencia Pol\'itica}; {\itshape Revista Chilena de Derecho y Ciencia Pol\'itica}; {\itshape V\'ia Iuris}}
\end{itemize}
\end{itemize}
